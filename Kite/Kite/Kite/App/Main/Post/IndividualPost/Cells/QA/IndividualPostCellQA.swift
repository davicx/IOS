//
//  IndividualPostCellQA.swift
//  Kite
//
//  Created by David Vasquez on 7/22/25.
//
...
/*
class IndividualPostCellQA: UITableViewCell {
    
    //Post User
    let postHeaderView = createHeaderView()
    let postHeaderLabel = createPostHeaderTextLabel()
    ...
    private func setupViews() {
        ...
        postHeaderLabel.translatesAutoresizingMaskIntoConstraints = false
        
        addSubview(postHeaderView)
        postHeaderView.addSubview(postHeaderLabel)
        ...
        NSLayoutConstraint.activate([
            ...
            postHeaderLabel.topAnchor.constraint(equalTo: postHeaderView.topAnchor, constant: 0),
            postHeaderLabel.leftAnchor.constraint(equalTo: postHeaderView.leftAnchor, constant: 0),
            postHeaderLabel.rightAnchor.constraint(equalTo: postHeaderView.rightAnchor, constant: -0),
            postHeaderLabel.bottomAnchor.constraint(equalTo: postHeaderView.bottomAnchor, constant: -0),
...
func createPostHeaderTextLabel() -> UILabel {
    let label = UILabel()
    label.text = "Post Header Text"
