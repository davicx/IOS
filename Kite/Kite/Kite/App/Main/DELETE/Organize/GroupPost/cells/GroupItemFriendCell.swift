...
//WISHLIST: Item
class GroupItemFriendCell: UITableViewCell {
    ...
    private func setupItemPurchasedViews() {
        ...
        NSLayoutConstraint.activate([
            ...
            // Label constraints
            friendLabel.centerXAnchor.constraint(equalTo: itemPurchasedView.centerXAnchor),
            friendLabel.centerYAnchor.constraint(equalTo: itemPurchasedView.centerYAnchor)
        ])
    }
