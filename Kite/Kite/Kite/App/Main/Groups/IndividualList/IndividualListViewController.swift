...
//  Kite
//
//  Created by David Vasquez on 8/17/25.
//

import UIKit


class IndividualListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        print("IndividualListViewController \(groupName)")
        print("________________________")
    ...
    private func fetchPostsForGroup() {
        ...
        print("IndividualListViewController: Fetching items for group ID \(groupID)")
...
extension IndividualListViewController: UITableViewDataSource, UITableViewDelegate {
