...
//Function 1: Get All Posts
//http://hellofour-env.eba-mymqvrea.us-west-2.elasticbeanstalk.com/posts/group/77
...
func makeTextPost(postFrom: String, postTo: String, postCaption: String) {
    let parameters = [
        "postType": "IOS",
        "postStatus": "1",
        "groupID": "77",
